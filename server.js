...
<head>
  ...
  <title>PermitWise - Never Miss a Permit Deadline Again</title>
  <meta name="description" content="PermitWise helps food vendors stay compliant with auto-tracking, reminders, and city-specific permit guidance.">
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; color: var(--gray-800); line-height: 1.6; }
    .container { max-width: 1200px; margin: 0 auto; padding: 0 24px; }
    
    /* Navigation */
    .nav { position: fixed; top: 0; left: 0; right: 0; background: rgba(255,255,255,0.95); backdrop-filter: blur(10px); z-index: 100; border-bottom: 1px solid var(--gray-100); }
    .nav-inner { max-width: 1200px; margin: 0 auto; padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; }
    .logo { display: flex; align-items: center; gap: 8px; font-weight: 700; font-size: 20px; color: var(--primary); text-decoration: none; }
    .logo svg { width: 32px; height: 32px; }
    .nav-links { display: flex; align-items: center; gap: 32px; }
    .nav-links a { color: var(--gray-600); text-decoration: none; font-weight: 500; font-size: 14px; }
    .nav-links a:hover { color: var(--primary); }
    .nav-actions { display: flex; gap: 12px; }
    
    /* Buttons */
    .btn { display: inline-flex; align-items: center; justify-content: center; padding: 12px 24px; border-radius: 8px; font-weight: 600; font-size: 14px; text-decoration: none; cursor: pointer; border: none; transition: all 0.2s; }
    ...
    /* Hero Section */
    .hero { padding: 160px 0 100px; background: linear-gradient(135deg, #eff6ff 0%, #f9fafb 100%); }
    .hero-inner { display: grid; grid-template-columns: 1fr 1fr; gap: 64px; align-items: center; }
    .hero h1 { font-size: 56px; font-weight: 700; line-height: 1.1; color: var(--gray-900); margin-bottom: 24px; }
    .hero p { font-size: 20px; color: var(--gray-600); margin-bottom: 32px; max-width: 500px; }
    .hero-cta { display: flex; gap: 16px; }
    .hero-visual { display: flex; justify-content: center; align-items: center; }
    .hero-icon { width: 300px; height: 300px; background: white; border-radius: 32px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.15); display: flex; align-items: center; justify-content: center; }
    .hero-icon svg { width: 150px; height: 150px; stroke: var(--primary); }
    
    /* Permit Checker Section */
    .permit-checker { padding: 100px 0; background: white; }
    ...
    .checker-card { max-width: 700px; margin: 0 auto; background: var(--gray-50); border-radius: 16px; padding: 32px; }
    .checker-form { display: grid; grid-template-columns: 1fr 1fr 1fr auto; gap: 16px; align-items: end; }
    .form-group { display: flex; flex-direction: column; gap: 6px; }
    .form-group label { font-size: 14px; font-weight: 500; color: var(--gray-700); }
    .form-group input, .form-group select { padding: 12px 16px; border: 1px solid var(--gray-300); border-radius: 8px; font-size: 14px; }
    ...
    .checker-results { margin-top: 32px; }
    .permit-result { display: flex; justify-content: space-between; align-items: center; padding: 16px; background: white; border-radius: 8px; margin-bottom: 8px; border: 1px solid var(--gray-200); }
    .permit-name { font-weight: 600; color: var(--gray-800); }
    .badge { padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600; }
    .badge-critical { background: #fee2e2; color: #991b1b; }
    .badge-warning { background: #fef3c7; color: #92400e; }
    .badge-info { background: #dbeafe; color: #1e40af; }
    .coverage-notice { display: flex; gap: 12px; padding: 16px; background: #fef3c7; border-radius: 8px; margin-top: 16px; }
    .coverage-notice svg { width: 20px; height: 20px; stroke: #d97706; flex-shrink: 0; }
    .coverage-notice p { color: #92400e; font-size: 14px; margin: 0; }
    
    /* Benefits Section */
    .benefits { padding: 100px 0; background: var(--gray-50); }
    .benefits-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 32px; }
    .benefit-card { background: white; border-radius: 16px; padding: 32px; text-align: center; }
    .benefit-icon { width: 64px; height: 64px; background: var(--primary-light); border-radius: 16px; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; }
    .benefit-icon svg { width: 32px; height: 32px; stroke: var(--primary); }
    .benefit-card h3 { font-size: 20px; font-weight: 600; color: var(--gray-900); margin-bottom: 12px; }
    .benefit-card p { color: var(--gray-600); font-size: 15px; }
    
    /* How It Works */
    .how-it-works { padding: 100px 0; background: white; }
    .steps { display: grid; grid-template-columns: repeat(3, 1fr); gap: 48px; margin-top: 48px; }
    .step { text-align: center; position: relative; }
    .step-number { width: 48px; height: 48px; background: var(--primary); color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 20px; margin: 0 auto 20px; }
    .step h3 { font-size: 18px; font-weight: 600; color: var(--gray-900); margin-bottom: 8px; }
    .step p { color: var(--gray-600); font-size: 15px; }
    .step::after { content: '→'; position: absolute; right: -24px; top: 20px; font-size: 24px; color: var(--gray-300); }
    ...
    .plan-card { background: white; border-radius: 16px; padding: 32px; text-align: center; border: 2px solid var(--gray-200); transition: all 0.2s; }
    .plan-card.featured { border-color: var(--primary); transform: scale(1.05); }
    .plan-card h3 { font-size: 24px; font-weight: 600; color: var(--gray-900); margin-bottom: 8px; }
    ...
    .plan-features li { padding: 8px 0; color: var(--gray-600); font-size: 14px; display: flex; align-items: center; gap: 8px; }
    ...
    .testimonial { background: var(--gray-50); border-radius: 16px; padding: 32px; }
    .testimonial-quote { font-style: italic; color: var(--gray-700); margin-bottom: 20px; font-size: 15px; line-height: 1.7; }
    .testimonial-author { display: flex; align-items: center; gap: 12px; }
    .testimonial-avatar { width: 48px; height: 48px; background: var(--primary-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 600; color: var(--primary); }
    ...
    .faq-question::after { content: '+'; font-size: 24px; color: var(--gray-400); }
    .faq-item.open .faq-question::after { content: '−'; }
    .faq-answer { padding: 0 24px 20px; color: var(--gray-600); display: none; }
    .faq-item.open .faq-answer { display: block; }
    
    /* Final CTA */
    .final-cta { padding: 100px 0; background: var(--primary); text-align: center; }
    .final-cta h2 { font-size: 36px; font-weight: 700; color: white; margin-bottom: 16px; }
    .final-cta p { font-size: 18px; color: rgba(255,255,255,0.8); margin-bottom: 32px; }
    .final-cta .btn-outline { color: white; border-color: rgba(255,255,255,0.3); }
    ...
    /* Footer */
    .footer { padding: 48px 0; background: var(--gray-900); color: var(--gray-400); }
    .footer-inner { display: flex; justify-content: space-between; align-items: center; }
    .footer-links { display: flex; gap: 24px; }
    .footer-links a { color: var(--gray-400); text-decoration: none; font-size: 14px; }
    .footer-links a:hover { color: white; }
    .footer-logo { display: flex; align-items: center; gap: 8px; color: white; font-weight: 600; }
    .footer-logo svg { width: 24px; height: 24px; stroke: white; }
    ...
    @media (max-width: 968px) {
      ...
      .benefits-grid, .steps, .pricing-grid, .testimonial-grid { grid-template-columns: 1fr; }
...
<body>
  ...
  <nav class="nav">
    <div class="nav-inner">
      ...
      <div class="nav-actions">
        <a href="/app" class="btn btn-outline btn-sm">Log In</a>
        <a href="/app?register=true" class="btn btn-primary btn-sm">Get Started Free</a>
      </div>
    </div>
  </nav>
    ...
    <div class="container">
      <div class="hero-inner">
        <div class="hero-content">
          <h1>Never Miss a Permit Deadline Again.</h1>
          <p>PermitWise helps food vendors stay compliant with auto-tracking, reminders, and city-specific permit guidance.</p>
          <div class="hero-cta">
            <a href="/app?register=true" class="btn btn-primary btn-lg">Get Started Free</a>
            <a href="#permit-checker" class="btn btn-outline btn-lg">See What Permits You Need</a>
          </div>
        </div>
        <div class="hero-visual">
          <div class="hero-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke-width="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Permit Checker Section -->
  <section class="permit-checker" id="permit-checker">
    <div class="container">
      <div class="section-header">
        <h2>What Permits Do You Need?</h2>
        <p>Enter your city and business type to see exactly which permits and licenses you need to operate legally.</p>
      </div>
      <div class="checker-card">
        <form class="checker-form" id="checkerForm">
          <div class="form-group">
            <label>City</label>
            <input type="text" id="checkerCity" placeholder="e.g. Austin" required>
          </div>
          <div class="form-group">
            <label>State</label>
            <select id="checkerState" required>
          ...
          <div class="form-group">
            ...
            <select id="checkerType" required>
              <option value="">Select</option>
              ...
              <option value="farmers_market">Farmers Market Vendor</option>
              <option value="ice_cream">Ice Cream Truck</option>
              <option value="coffee">Coffee/Beverage Cart</option>
            </select>
          </div>
          <button type="submit" class="btn btn-primary">Find Permits</button>
        </form>
        <div id="checkerResults" class="checker-results" style="display:none;"></div>
      </div>
    </div>
  </section>
  ...
  <section class="benefits" id="features">
    <div class="container">
      <div class="section-header">
        ...
        <p>Focus on your business, not paperwork. PermitWise handles the complexity.</p>
      </div>
      <div class="benefits-grid">
        <div class="benefit-card">
          ...
          <h3>Track All Permits</h3>
          <p>Keep all your permits, licenses, and documents in one organized dashboard. Never lose track of what you have or what you need.</p>
        </div>
        <div class="benefit-card">
          <div class="benefit-icon">
          ...
          <p>Get email and SMS alerts before permits expire. We'll remind you 30, 14, and 7 days out so you're never caught off guard.</p>
        </div>
        <div class="benefit-card">
          <div class="benefit-icon">
          ...
          <h3>City-Specific Guidance</h3>
          <p>Our database knows which permits each city requires. Get personalized checklists based on where you operate.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="how-it-works">
    <div class="container">
      <div class="section-header">
        <h2>How PermitWise Works</h2>
        <p>Get compliant in three simple steps</p>
      </div>
      <div class="steps">
        <div class="step">
          <div class="step-number">1</div>
          <h3>Tell Us Your City</h3>
          <p>Enter where you operate and what type of vendor you are. Takes 30 seconds.</p>
        </div>
        <div class="step">
          <div class="step-number">2</div>
          <h3>See Required Permits</h3>
          <p>We show you exactly which permits you need, marked by importance level.</p>
        </div>
        <div class="step">
          <div class="step-number">3</div>
          <h3>Track & Stay Compliant</h3>
          <p>Upload your permits, set expiration dates, and we'll handle the reminders.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="pricing-grid">
        <div class="plan-card">
          ...
          <a href="/app?register=true" class="btn btn-outline" style="width:100%">Start Free Trial</a>
        </div>
        <div class="plan-card featured">
          ...
          <a href="/app?register=true" class="btn btn-primary" style="width:100%">Start Free Trial</a>
        </div>
        <div class="plan-card">
          <h3>Elite</h3>
  ...
  <section class="testimonials">
    <div class="container">
      <div class="section-header">
        <h2>Loved by Food Vendors</h2>
        <p>Join thousands of vendors who never miss a deadline</p>
      </div>
      <div class="testimonial-grid">
        <div class="testimonial">
          <p class="testimonial-quote">"Before PermitWise, I got fined twice for expired permits. Now I get reminders weeks in advance. It's saved me thousands."</p>
          <div class="testimonial-author">
            <div class="testimonial-avatar">MR</div>
            <div>
              <div class="testimonial-name">Maria Rodriguez</div>
              <div class="testimonial-role">Taco Truck Owner, Austin TX</div>
            </div>
          </div>
        </div>
        <div class="testimonial">
          <p class="testimonial-quote">"Managing permits across 3 cities was a nightmare. PermitWise keeps everything organized in one place. Game changer."</p>
          <div class="testimonial-author">
            <div class="testimonial-avatar">JK</div>
            <div>
              <div class="testimonial-name">James Kim</div>
              <div class="testimonial-role">Food Trailer Owner, LA</div>
            </div>
          </div>
        </div>
        <div class="testimonial">
          <p class="testimonial-quote">"The city-specific checklists told me about permits I didn't even know I needed. Worth every penny."</p>
          <div class="testimonial-author">
            <div class="testimonial-avatar">ST</div>
            <div>
              <div class="testimonial-name">Sarah Thompson</div>
              <div class="testimonial-role">Pop-up Restaurant, NYC</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="faq" id="faq">
    <div class="container">
      ...
      <div class="faq-list">
        <div class="faq-item">
          <div class="faq-question" onclick="this.parentElement.classList.toggle('open')">What is PermitWise?</div>
          <div class="faq-answer">PermitWise is a permit management platform designed specifically for mobile food vendors. We help you track all your permits, send automatic renewal reminders, and provide city-specific guidance on what permits you need.</div>
        </div>
        <div class="faq-item">
          <div class="faq-question" onclick="this.parentElement.classList.toggle('open')">How does the free trial work?</div>
          <div class="faq-answer">You get a full 14-day free trial with access to all features. No credit card required to start. At the end of your trial, choose the plan that fits your needs or downgrade to limited free access.</div>
        </div>
        <div class="faq-item">
          <div class="faq-question" onclick="this.parentElement.classList.toggle('open')">Which cities do you cover?</div>
          <div class="faq-answer">We're actively building our database of permit requirements. Major cities like Austin, Houston, Los Angeles, and New York are fully covered. If your city isn't in our database yet, you can still track permits manually and we'll notify you when full support is added.</div>
        </div>
        <div class="faq-item">
          <div class="faq-question" onclick="this.parentElement.classList.toggle('open')">Do you file permits for me?</div>
          <div class="faq-answer">No, PermitWise is a tracking and reminder tool. We don't file permits on your behalf or guarantee approval. We help you stay organized and never miss deadlines, but you're responsible for the actual permit applications.</div>
        </div>
        <div class="faq-item">
          <div class="faq-question" onclick="this.parentElement.classList.toggle('open')">Can I cancel anytime?</div>
          <div class="faq-answer">Yes! You can cancel your subscription at any time. Your account will remain active until the end of your current billing period. We don't do contracts or cancellation fees.</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="final-cta">
    <div class="container">
      <h2>Ready to Simplify Your Permit Management?</h2>
      <p>Join thousands of food vendors who trust PermitWise to stay compliant.</p>
      <div class="final-cta-buttons">
        <a href="/app?register=true" class="btn btn-primary btn-lg">Start Free Today</a>
        <a href="#permit-checker" class="btn btn-outline btn-lg">Check Permits in Your City</a>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="footer-inner">
        ...
        <div class="footer-links">
          ...
          <a href="mailto:support@permitwise.app">Contact</a>
        </div>
        <div class="footer-copy">© 2025 PermitWise. All rights reserved.</div>
      </div>
    </div>
  </footer>
  ...
  <script>
    ...
    document.getElementById('checkerForm').addEventListener('submit', async (e) => {
      e.preventDefault();
      const city = document.getElementById('checkerCity').value;
      const state = document.getElementById('checkerState').value;
      const vendorType = document.getElementById('checkerType').value;
      
      try {
        const response = await fetch('/api/permit-types/required?city=' + encodeURIComponent(city) + '&state=' + encodeURIComponent(state) + '&vendorType=' + encodeURIComponent(vendorType));
        const data = await response.json();
        
        const resultsDiv = document.getElementById('checkerResults');
        resultsDiv.style.display = 'block';
        
        if (data.permitTypes && data.permitTypes.length > 0) {
          const isPartial = data.permitTypes.length < 4;
          let html = '<h3 style="margin-bottom:16px;">' + data.permitTypes.length + ' permit(s) required in ' + city + ', ' + state + '</h3>';
          
          if (isPartial) {
            html += '<div class="coverage-notice"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg><p>We\\'re still adding full coverage for this city. You can track permits manually in the app.</p></div>';
          }
          
          data.permitTypes.forEach(pt => {
            let badgeClass = 'badge-critical';
            let badgeText = 'Critical';
            if (pt.importanceLevel === 'often_forgotten') { badgeClass = 'badge-warning'; badgeText = 'Often Forgotten'; }
            else if (pt.importanceLevel === 'event_required') { badgeClass = 'badge-info'; badgeText = 'Event Required'; }
            
            html += '<div class="permit-result"><div><div class="permit-name">' + pt.name + '</div><div style="font-size:13px;color:#6b7280;margin-top:4px;">Renews every ' + (pt.renewalPeriodMonths || 12) + ' months</div></div><span class="badge ' + badgeClass + '">' + badgeText + '</span></div>';
          });
          
          html += '<div style="margin-top:24px;text-align:center;"><a href="/app?register=true" class="btn btn-primary">Track These Permits Free →</a></div>';
          resultsDiv.innerHTML = html;
        } else {
          resultsDiv.innerHTML = '<div style="text-align:center;padding:24px;"><svg viewBox="0 0 24 24" fill="none" stroke="#9ca3af" stroke-width="2" style="width:48px;height:48px;margin:0 auto 16px;"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg><h3 style="margin-bottom:8px;">We\\'re building coverage for ' + city + '</h3><p style="color:#6b7280;margin-bottom:16px;">You can still track your permits manually in the app. We\\'ll notify you when full support is ready.</p><a href="/app?register=true" class="btn btn-primary">Start Tracking Manually →</a></div>';
        }
      } catch (err) {
        console.error(err);
        document.getElementById('checkerResults').innerHTML = '<p style="color:#ef4444;">Error checking permits. Please try again.</p>';
